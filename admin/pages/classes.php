                  ...
                  <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
                        <div class="p-6">
                              <div class="flex items-center justify-between mb-4">
                                    <div class="w-12 h-12 rounded-2xl bg-green-50 flex items-center justify-center text-green-600 transition-colors group-hover:bg-green-600 group-hover:text-white">
                              ...
                              <div class="mb-6">
                                    ...
                                    <select 
                                          ...
                                          class="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-sm font-semibold text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:bg-white transition-all appearance-none cursor-pointer">
...
<div class="hidden fixed inset-0 bg-black/90 flex items-center justify-center p-2 z-[99999] backdrop-blur-md"
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden fadeIn">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50">
                  <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center">
                              <i class="bx-door-open text-green-600"></i>
                        </div>
            ...
            <form id="create-class-form" class="p-6 flex flex-col gap-5">
                  ...
                  <button type="submit"
                        class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all duration-200 font-bold text-sm cursor-pointer shadow-lg shadow-green-100"
