...
// Get all classes
$stmt = $conn->query("SELECT * FROM class ORDER BY id ASC");
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                <div class="size-10 rounded-2xl bg-emerald-100 flex items-center justify-center shrink-0 shadow-sm border border-emerald-200">
                    <i class="bx bx-transfer-alt text-emerald-600 text-2xl"></i>
                </div>
                <div>
                    <h3 class="text-xl md:text-2xl font-semibold text-gray-800 tracking-tight">Student Promotion</h3>
                    <p class="text-sm text-gray-400 font-medium">Batch promote students to new classes for the new term.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-orange-50 rounded-3xl p-6 border border-orange-100">
                <div class="flex gap-3 text-orange-800">
                    ...
                    <p class="text-sm font-medium leading-relaxed">
                        <span class="font-bold">Heads up:</span> This action updates the core class assignment for the selected students. Please ensure the target class is correct before confirming promotion.
                    </p>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#fromClass').on('change', function() {
        // use .attr('data-next') to prevent jQuery from parsing empty string as undefined
